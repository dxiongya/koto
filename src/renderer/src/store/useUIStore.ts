...
interface UIState {
  ...
  // Notebook (agent mode) — id of the currently-open session, or null when closed.
  ...
  setNotebookSession: (id: string | null) => void
...
export const useUIStore = create<UIState>((set, get) => ({
  ...
  setNotebookSession: (id) => set({ notebookSessionId: id }),
